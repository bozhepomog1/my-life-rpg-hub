  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <div className="mt-6 space-y-6 text-sm leading-relaxed text-foreground/90">
        ...
        <section>
          <h2 className="text-sm font-semibold">Выгрузка данных</h2>
          <p className="mt-2">
            В любой момент можно скачать всё, что хранится о тебе: Настройки → Аккаунт и
            безопасность → «Скачать мои данные». Получишь один JSON-файл с прогрессом, профилем,
            заявками в друзья, подписками на уведомления, адресом почты и списком загруженных
            файлов.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Удалить аккаунт можно самостоятельно и сразу: Настройки → Аккаунт и безопасность →
            «Удалить аккаунт навсегда». Удаление происходит немедленно и необратимо — вместе с
            аккаунтом стираются прогресс, профиль, заявки в друзья, подписки на уведомления, адрес
            почты и все загруженные фото. Периода отмены нет, восстановить данные после удаления
            невозможно, поэтому перед этим имеет смысл скачать выгрузку. Если что-то пошло не так
            или удалить аккаунт через интерфейс не получается — напиши на адрес ниже.
          </p>
        </section>
